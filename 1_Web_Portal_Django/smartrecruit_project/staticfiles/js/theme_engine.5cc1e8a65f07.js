(function () {
    ...
    function runPreloader() {
        ...
        function advance() {
            ...
            stepIndex += 1;
            timer = window.setTimeout(advance, reducedMotion ? 60 : 230);
        }
        ...
        function finish() {
            ...
            window.setTimeout(hidePreloader, reducedMotion ? 20 : 260);
        }
        ...
        window.setTimeout(finish, reducedMotion ? 180 : 3200);
